...
const SPRITE_COLS = 6;          // flap frames across the sheet (assets/canary.png)
const NBIRDS = 320;
...
function placeholderSprite() {
  ...
  for (let i = 0; i < SPRITE_COLS; i++) {
    ...
    // wing angle sweeps up->down->up across however many frames
    const wy = f * (0.5 - 0.18 * Math.cos((i / SPRITE_COLS) * Math.PI * 2));
